...
plugins=(git vi-mode tmux terraform)
...
convert_to_pdf() {
	if [ "$#" -ne 1 ]; then
		echo "Usage: convert_to_pdf <markdown_file>"
		return 1
	fi
...
__conda_setup="$('/Users/andrerepanich/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/andrerepanich/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/andrerepanich/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/andrerepanich/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
# pnpm
export PNPM_HOME="/Users/andrerepanich/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
